...
const HeroSection = () => {
    ...
    const fullName = useGetProfileData( ["user", "fullName"]);
    const roles = useGetProfileData( ["user", "roles"]);

    return (
        <section className="h-screen bg-hero bg-slate-800 overflow-hidden  relative flex justify-center items-center">
